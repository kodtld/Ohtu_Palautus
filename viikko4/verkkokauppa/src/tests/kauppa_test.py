...
class TestKauppa(unittest.TestCase):
    ...
    def test_kaksi_eri_tuotetta_ja_ostos(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_kaksi_samaa_tuotetta_ja_ostos(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(2)
        self.kauppa.lisaa_koriin(2)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_kaksi_eri_tuotetta_joista_toinen_loppu_ja_ostos(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(2)
    ...
    def test_tuote_on_loppu_ja_ostos(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(3)
        self.kauppa.tilimaksu("pekka", "12345")
        self.kauppa.aloita_asiointi()
        ...
        self.pankki_mock.lisaa_koriin.assert_not_called()
